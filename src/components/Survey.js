      ...
      questions = <span>
        ...
        <form onSubmit={ this.handleQuestionSubmit.bind( this ) }>
          <div>
            ...
            <input className='option-input checkbox' type='radio' name='q1' value='Windows' onChange={ this.handleQuestionChange }/>Windows<br />
          ...
          <div>
            ...
            <input className='option-input checkbox' type='radio' name='q4' value='Intel' onChange={ this.handleQuestionChange }/>Intel<br />
